        ...
        <div className="premium-card relative overflow-hidden rounded-3xl border border-white/10 bg-gradient-to-b from-white/[0.06] to-white/[0.02] p-8 sm:p-12">
          ...
          <div className="relative space-y-6">
            ...
            <p className="text-xs text-neutral-500 leading-relaxed">
              If you’re new: start here. Then go to Learn for the full walkthrough.
            </p>
          </div>
        </div>
      </Reveal>
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-3">
              <FaqItem n="1" q="What is REZIME Engine?">
                <p>
                  REZIME Engine is a{" "}
                  <span className="font-semibold text-white">market regime map</span>.
              ...
              <FaqItem n="2" q='Is REZIME Engine a “signal indicator”?'>
                ...
                <p>
                  REZIME Engine is{" "}
                  <span className="font-semibold text-white">map, not signals</span>.
              ...
              <FaqItem n="5" q="Is REZIME Engine the holy grail?">
                ...
                <p>
                  ...
                  <span className="font-semibold text-white">supplementary</span> by nature.
                ...
                <p>
                  ...
                  <span className="font-semibold text-white">right</span> in the wrong regime.
                </p>
              </FaqItem>
              ...
              <FaqItem n="6" q="What markets does REZIME Engine work on?">
                ...
                <p>
                  If price moves, supply and demand exist, and there is a usable chart —
                  then REZIME applies.
                </p>

                <p className="text-xs text-neutral-500">
                  Includes (but not limited to): stocks, crypto, indices, forex, metals, futures, commodities,
                  bonds, and more.
                </p>
              </FaqItem>
              ...
              <FaqItem n="7" q="What timeframe should I use?">
                ...
                <p className="text-xs text-neutral-500">
                  As skill increases, faster timeframes become usable — but they require discipline and strong risk control.
                </p>
              </FaqItem>
              ...
              <FaqItem n="9" q="REZIME Sync: how do I choose timeframes? (the 3–5 gap rule)">
                ...
                <div className="rounded-xl border border-white/10 bg-black/30 p-4">
                  ...
                  <div className="mt-2 text-sm text-neutral-300">
                    Sweet spot: <span className="text-white">3 to 5 steps</span> · Maximum:{" "}
              ...
              <FaqItem n="10" q="Where can I see proof that it works?">
                ...
                <p>It documents REZIME across real markets and real regimes, with a focus on:</p>
                <ul className="list-disc pl-5 space-y-1">
