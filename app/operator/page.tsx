      ...
      <section className="grid gap-8 lg:grid-cols-[240px_1fr]">
        ...
        <div className="space-y-12">
          ...
          <Section
            ...
            desc="Your philosophy: make trades riskless ASAP, then let upside be unlimited."
          >
            <div className="grid gap-4 lg:grid-cols-2">
              <div className="rounded-2xl border border-white/10 bg-white/5 p-6 space-y-3 text-sm text-neutral-300 leading-relaxed">
                ...
                <p>
                  ...
                  LTF + MTF alignment, often near an MTF transition (SMA100 break)
                  with early EMA respect.
                </p>
                <p>
              ...
              <div className="rounded-2xl border border-white/10 bg-white/5 p-6 space-y-3 text-sm text-neutral-300 leading-relaxed">
                ...
                <p>
                  Exit is not “took profit.” Exit is “structure broke.” You stay
                  until a real reversal challenges MTF/HTF and confirms a regime flip.
                </p>
                <p>
          ...
          <Section
            ...
            desc="These sections are where you’ll later paste screenshots of the regime strip only (MA hidden), to prove behavior without leaking construction."
          >
            <div className="grid gap-4 lg:grid-cols-3">
          ...
          >
            <div className="rounded-2xl border border-white/10 bg-white/5 p-6 space-y-3 text-sm text-neutral-300 leading-relaxed">
              <p>
                Public proofs will show the <span className="text-white font-semibold">regime strip</span>{" "}
                and state labels only (Empire/Rebellion/Uprising/Revolution).
              </p>
              <p>
                The moving average construction and territory/border logic remain
                internal until subscriber access is released.
              </p>
